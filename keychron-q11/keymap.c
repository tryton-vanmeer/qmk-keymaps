...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_91_ansi(
        ...
        _______,  KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            KC_PGUP,
        ...
        _______,  KC_LCTL,  KC_LGUI,  KC_LALT,  MO(FN),         KC_SPC,                        KC_SPC,             KC_LALT,  MO(FN1), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
    [FN] = LAYOUT_91_ansi(
        ...
        KC_F15,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  UC(EMDASH),    _______,  _______,            _______,
        ...
        _______,  _______,            _______,  _______,  UC(COPYLEFT),  UC(CHECKMARK),   QK_BOOT,  _______,  _______,  _______,  UC(MIDDLEDOT),  SS_HOME,              _______,  _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [FN]  = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [FN1]   = { ENCODER_CCW_CW(RGB_MOD, RGB_RMOD), ENCODER_CCW_CW(KC_MS_WH_LEFT, KC_MS_WH_RIGHT) },
};
